defmodule HackPop.ClientTest do
  ...
  test "recent_unread_notifications excludes unread" do
    client        = Repo.insert! %Client{client_id: "123"}
    _notification = Repo.insert! %Notification{client_id: client.id,
                                               story_id: 1,
                                               read: true}

    assert [] == Client.recent_unread_notifications(client)
  end

  test "recent_unread_notifications exludes older than 5 days" do
    client       = Repo.insert! %Client{client_id: "123"}
